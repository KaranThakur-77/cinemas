...
if ($conn->connect_error) {
    ...
    if ($res->num_rows>0) {
       ...
       <tr>
            ...
            <td>
                <a href="edit-form.php?id=<?php echo $row['id'];?>&title=<?php echo $row['title'];?>&rating=<?php echo $row['rating'];?>&desc=<?php echo $row['description'];?>"><i class="fa-solid fa-pen-to-square"></i></a>
